...
public class ExcelUtils {
    ...
    public static <T> List<T> importExcel(String filePath, Integer titleRows, Integer headerRows, Class<T> pojoClass) throws IOException {
        ...
        try {
            return (new MyExcelImportService()).importExcelByIs(new FileInputStream(new File(filePath)), pojoClass, params, false).getList();
    ...
    public static <T> List<T> importExcel(InputStream inputStream, Integer titleRows, Integer headerRows, boolean needVerfiy, Class<T> pojoClass) throws IOException {
        ...
        try {
            return (new MyExcelImportService()).importExcelByIs(inputStream, pojoClass, params, false).getList();
        } catch (NoSuchElementException e) {
