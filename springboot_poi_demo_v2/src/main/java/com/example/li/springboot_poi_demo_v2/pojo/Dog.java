package com.example.li.springboot_poi_demo_v2.pojo;
...
public class Dog implements Serializable {
    ...
    public Map<String, Object> toMap(){
        ...
        map.put("dog_name", getDog_name());
        map.put("dog_sex", getDog_sex());
        map.put("dog_age", getDog_age());
        map.put("dog_height", getDog_height());
        map.put("dog_kind", getDog_kind());
        return map;
    }
