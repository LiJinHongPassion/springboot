文章转载地址：https://juejin.im/post/59f1b2766fb9a0450e755993#heading-18

demo地址：https://github.com/LiJinHongPassion/springboot/tree/master/springboot_shiro_jwt_demo
...
- [JWT](https://link.juejin.im/?target=https%3A%2F%2Fjwt.io%2F) （Json Web Token）的基本概念，并且会简单操作JWT的 [JAVA SDK](https://link.juejin.im/?target=https%3A%2F%2Fgithub.com%2Fauth0%2Fjava-jwt)。
- Shiro的基本操作，看下官方的 [10 Minute Tutorial](https://link.juejin.im/?target=http%3A%2F%2Fshiro.apache.org%2F10-minute-tutorial.html) 即可。
...
大家可以先看下官方的 [Spring-Shiro](https://link.juejin.im/?target=http%3A%2F%2Fshiro.apache.org%2Fspring.html) 整合教程，有个初步的了解。不过既然我们用了`Spring-Boot`，那我们肯定要争取零配置文件。
...
**requireRole**
smith只有user角色，不能访问admin角色的方法，报错
![](./7.jpg)

**requirePermission**
smith只有view权限，不能访问view和eidit权限同时存在的方法
![](./8.jpg)
...
**requireRole**
danny有admin角色，能成功访问admin角色的方法
![](./13.jpg)

**requirePermission**
danny有view权限，能成功访问view和eidit权限同时存在的方法
![](./14.jpg)
